...
int main(){
    ...
    char ch;
    //Criar variável para guardar dois números para as operações matemáticas
    int a,b;

    printf("Digite uma operação matemática: +,-,*,/\n ");
    //vamos capturar o sinal digitado pelo usuário e alocar na variável ch.
    //Usaremos o comando getchar, que vem da biblioteca stdlib
    //Caso você queira usar o scanf, poderia ser feito da seguinte forma: scanf("%c",&ch);
    ch=getchar();
    ...
    case '+':
        ...
        case '/':
        int f=a/b;
        printf("O resultado de divisão é %d\n", f);
        break;
